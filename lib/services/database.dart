...
class AppDatabase {
  ...
  Future<Database> get database async {
    ...
    _db=await openDatabase(join(root,'offline_ai_school.db'),version:5,onCreate:(db,_)=>_createSchema(db),onUpgrade:(db,oldVersion,_) async {
  ...
  Future<void> _createSchema(Database db) async {
    ...
    await db.execute('''CREATE TABLE attempts(id INTEGER PRIMARY KEY AUTOINCREMENT,client_id TEXT NOT NULL UNIQUE,question_id TEXT NOT NULL,topic_id TEXT NOT NULL,correct INTEGER NOT NULL,timestamp TEXT NOT NULL,attempt_type TEXT NOT NULL DEFAULT "practice",selected_answer TEXT,duration_ms INTEGER,synced INTEGER NOT NULL DEFAULT 0)''');
  }
